    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md gradient-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-[var(--shadow-elegant)]"
          >
            Go to Dashboard
          </Link>
        </div>
          ...
          <div className="flex min-h-screen w-full bg-background">
            ...
            <SidebarInset className="flex flex-1 flex-col min-w-0">
              ...
              <footer className="border-t border-border/60 px-6 py-4 text-center text-xs text-muted-foreground">
                © {new Date().getFullYear()} AI Workplace · Built with responsible AI practices ·{" "}
                <Link to="/help" className="hover:text-primary">Help & Ethics</Link>
              </footer>
            </SidebarInset>
          </div>
